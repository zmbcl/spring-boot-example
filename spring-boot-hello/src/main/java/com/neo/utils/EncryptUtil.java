...
public class EncryptUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String  encryptByPrivateKey= encryptByPrivateKey(content, privateKey);
        System.out.println("5.私钥加密："+encryptByPrivateKey);
        System.out.println("6.公钥解密："+decryptByPublicKey(encryptByPrivateKey,publicKey));
